...
interface ITodoList {
  toDoList: Array<any>;
  handleClickPassItem(id: number): void;
  handleClickSuccessItem(id: number): void;
}

const TodoList: FC<ITodoList> = memo(
  ({ toDoList, handleClickPassItem, handleClickSuccessItem }) => {
    return (
